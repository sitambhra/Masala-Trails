...
const PrivacyPolicy = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-orange-100 to-yellow-200 text-gray-800 py-10 px-5 md:px-20">
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-8">
        ...
        <h2 className="text-2xl font-semibold text-orange-500 mt-6">Cookies</h2>
        <p className="text-gray-700 mt-2">
