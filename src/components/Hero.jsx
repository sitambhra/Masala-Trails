  ...
  return (
    <div className="relative h-[500px] flex items-center justify-center">
      <div
        ...
        style={{
          backgroundImage: 'url(https://images.unsplash.com/photo-1543353071-087092ec393a?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80)',
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <p className="text-xl text-white mb-8 max-w-2xl mx-auto">
          Discover authentic recipes from around the world, crafted with love and tradition
        </p>
