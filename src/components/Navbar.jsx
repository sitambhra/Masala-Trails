        ...
        <div className="max-w-7xl mx-auto px-4">
          <div data-aos="fade-up" className="flex justify-between items-center h-16">
            ...
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-800 dark:text-white ">Masala Trails</span>
            </Link>
            ...
            <div className="hidden md:flex items-center space-x-8 ml-auto">
              ...
              {isAuthenticated ? (
                ...
                <Link to="/login" className="text-gray-600 hover:text-orange-500 transition-colors dark:text-white">Login</Link>
              )}
              <Link to="/submit">
