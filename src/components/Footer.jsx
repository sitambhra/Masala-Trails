          ...
          <div>
            ...
            <div className="flex">
              <input
                ...
                className="flex-1 px-2  lg:px-4 py-2 rounded-l-md text-gray-800 w-[60%] md:w-[80%] lg:w-[100%]"
              />
              <button className="bg-orange-500 px-2 lg:px-4 py-2 rounded-r-md hover:bg-orange-600 transition-colors">
                Subscribe
              </button>
            </div>
